...
function dilate(image, options = {}) {
    ...
    if (image instanceof Image_1.Image) {
        (0, checkProcessable_1.default)(image, 'dilate', {
            bitDepth: [Image_1.ColorDepth.UINT1, Image_1.ColorDepth.UINT8, Image_1.ColorDepth.UINT16],
            components: 1,
            alpha: false,
        });
    }
    (0, checkKernel_1.checkKernel)(kernel, 'dilate');
    let onlyOnes = true;
    if (!defaultKernel) {
