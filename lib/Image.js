...
exports.Image = exports.ImageCoordinates = exports.ColorDepth = exports.colorModels = exports.ImageColorModel = void 0;
const compare_1 = require("./compare");
const median_1 = require("./compute/median");
const variance_1 = require("./compute/variance");
const correctColor_1 = require("./correctColor");
const draw_1 = require("./draw");
const drawPoints_1 = require("./draw/drawPoints");
const filters_1 = require("./filters");
const morphology_1 = require("./morphology");
const operations_1 = require("./operations");
const cropAlpha_1 = require("./operations/cropAlpha");
const colorModels_1 = require("./utils/constants/colorModels");
const validators_1 = require("./utils/validators");
const _1 = require(".");
var colorModels_2 = require("./utils/constants/colorModels");
Object.defineProperty(exports, "ImageColorModel", { enumerable: true, get: function () { return colorModels_2.ImageColorModel; } });
Object.defineProperty(exports, "colorModels", { enumerable: true, get: function () { return colorModels_2.colorModels; } });
/**
...
})(ColorDepth = exports.ColorDepth || (exports.ColorDepth = {}));
...
})(ImageCoordinates = exports.ImageCoordinates || (exports.ImageCoordinates = {}));
class Image {
    /**
    ...
    constructor(width, height, options = {}) {
        const { depth = ColorDepth.UINT8, data, colorModel = colorModels_1.ImageColorModel.RGB, origin = { row: 0, column: 0 }, } = options;
        ...
        this.origin = origin;
        const colorModelDef = colorModels_1.colorModels[colorModel];
  ...
  data: ${dataString}
    ...
    fill(value) {
        if (typeof value === 'number') {
            (0, validators_1.validateValue)(value, this);
            ...
            for (const val of value)
                (0, validators_1.validateValue)(val, this);
    ...
    fillChannel(channel, value) {
        (0, validators_1.validateChannel)(channel, this);
        (0, validators_1.validateValue)(value, this);
    ...
    subtract(other, options = {}) {
        return (0, compare_1.subtract)(this, other, options);
    }
    // COMPUTE
    histogram(options) {
        return (0, _1.histogram)(this, options);
    }
    /**
     ...
     */
    variance() {
        return (0, variance_1.variance)(this);
    }
    // DRAW
    /**
    ...
    drawPoints(points, options = {}) {
        return (0, drawPoints_1.drawPoints)(this, points, options);
    }
    /**
    ...
    drawLine(from, to, options = {}) {
        return (0, draw_1.drawLineOnImage)(this, from, to, options);
    }
    /**
    ...
    drawRectangle(options = {}) {
        return (0, draw_1.drawRectangle)(this, options);
    }
    /**
    ...
    drawPolyline(points, options = {}) {
        return (0, draw_1.drawPolylineOnImage)(this, points, options);
    }
    /**
    ...
    drawPolygon(points, options = {}) {
        return (0, draw_1.drawPolygonOnImage)(this, points, options);
    }
    /**
    ...
    drawCircle(center, radius, options = {}) {
        return (0, draw_1.drawCircleOnImage)(this, center, radius, options);
    }
    // OPERATIONS
    split() {
        return (0, operations_1.split)(this);
    }
    convertColor(colorModel, options) {
        return (0, operations_1.convertColor)(this, colorModel, options);
    }
    convertDepth(newDepth) {
        return (0, operations_1.convertDepth)(this, newDepth);
    }
    grey(options) {
        return (0, operations_1.grey)(this, options);
    }
    copyTo(target, options = {}) {
        return (0, operations_1.copyTo)(this, target, options);
    }
    threshold(options = {}) {
        return (0, _1.threshold)(this, options);
    }
    /**
     ...
     */
    crop(options) {
        return (0, operations_1.crop)(this, options);
    }
    /**
     ...
     */
    cropAlpha(options = {}) {
        return (0, cropAlpha_1.cropAlpha)(this, options);
    }
    /**
    ...
    extract(mask, options) {
        return (0, _1.extract)(this, mask, options);
    }
    /**
    ...
    paintMask(mask, options) {
        return (0, operations_1.paintMaskOnImage)(this, mask, options);
    }
    // FILTERS
    blur(options) {
        return (0, filters_1.blur)(this, options);
    }
    directConvolution(kernel, options) {
        return (0, filters_1.directConvolution)(this, kernel, options);
    }
    /**
    ...
    rawDirectConvolution(kernel, options) {
        return (0, filters_1.rawDirectConvolution)(this, kernel, options);
    }
    separableConvolution(kernelX, kernelY, options) {
        return (0, filters_1.separableConvolution)(this, kernelX, kernelY, options);
    }
    /**
    ...
    gaussianBlur(options) {
        return (0, filters_1.gaussianBlur)(this, options);
    }
    /**
     * Flip the image.
     *
     ...
     */
    flip(options) {
        return (0, filters_1.flip)(this, options);
    }
    /**
     ...
     */
    invert(options) {
        return (0, filters_1.invert)(this, options);
    }
    /**
    ...
    hypotenuse(other, options) {
        return (0, filters_1.hypotenuse)(this, other, options);
    }
    /**
    ...
    gradientFilter(options) {
        return (0, filters_1.gradientFilter)(this, options);
    }
    /**
    ...
    derivativeFilter(options) {
        return (0, filters_1.derivativeFilter)(this, options);
    }
    /**
     ...
     */
    level(options) {
        return (0, filters_1.level)(this, options);
    }
    /**
    ...
    correctColor(measuredColors, referenceColors) {
        return (0, correctColor_1.correctColor)(this, measuredColors, referenceColors);
    }
    // GEOMETRY
    rotate(angle, options) {
        return (0, _1.rotate)(this, angle, options);
    }
    resize(options) {
        return (0, _1.resize)(this, options);
    }
    transform(transformMatrix, options) {
        return (0, _1.transform)(this, transformMatrix, options);
    }
    // MORPHOLOGY
    /**
     * Erode an image.
     ...
     */
    erode(options) {
        return (0, morphology_1.erode)(this, options);
    }
    /**
     * Dilate an image.
     *
     ...
     */
    dilate(options) {
        return (0, morphology_1.dilate)(this, options);
    }
    /**
     * Open an image.
     *
     ...
     */
    open(options) {
        return (0, morphology_1.open)(this, options);
    }
    /**
     * Close an image.
     *
     ...
     */
    close(options) {
        return (0, morphology_1.close)(this, options);
    }
    /**
     * Top hat of an image.
     *
     ...
     */
    topHat(options) {
        return (0, morphology_1.topHat)(this, options);
    }
    /**
     ...
     */
    bottomHat(options) {
        return (0, morphology_1.bottomHat)(this, options);
    }
    /**
    ...
    morphologicalGradient(options) {
        return (0, morphology_1.morphologicalGradient)(this, options);
    }
    /**
    ...
    cannyEdgeDetector(options) {
        return (0, morphology_1.cannyEdgeDetector)(this, options);
    }
}
exports.Image = Image;
/**
