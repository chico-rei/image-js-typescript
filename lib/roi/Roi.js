...
exports.Roi = void 0;
const getBorderPoints_1 = require("./getBorderPoints");
const getMask_1 = require("./getMask");
class Roi {
    constructor(map, id) {
        this.map = map;
        this.id = id;
     ...
     */
    getMask(options) {
        return (0, getMask_1.getMask)(this, options);
    }
    /**
    ...
    getBorderPoints(options) {
        return (0, getBorderPoints_1.getBorderPoints)(this, options);
    }
}
exports.Roi = Roi;
