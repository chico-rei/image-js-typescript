...
exports.getGaussianValues = exports.getGaussianPoints = void 0;
...
exports.getGaussianPoints = getGaussianPoints;
/**
...
function getGaussianValues(size, seed, nbValues, sigma = size / 5) {
    ...
    const array = (0, ml_spectra_processing_1.createRandomArray)({
        distribution: 'normal',
        seed,
        length: nbValues,
    ...
    const clamp = (0, clamp_1.getClampFromTo)(-width, width);
...
exports.getGaussianValues = getGaussianValues;
