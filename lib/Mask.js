...
const maskAnalysis_1 = require("./maskAnalysis");
const getMbr_1 = require("./maskAnalysis/getMbr");
const morphology_1 = require("./morphology");
const erode_1 = require("./morphology/erode");
const operations_1 = require("./operations");
const boolToNumber_1 = require("./utils/boolToNumber");
class Mask {
    /**
    ...
    constructor(width, height, options = {}) {
        ...
        this.depth = Image_1.ColorDepth.UINT1;
        this.colorModel = Image_1.ImageColorModel.BINARY;
        this.origin = origin;
        const colorModelDef = Image_1.colorModels[this.colorModel];
    ...
    setBitByIndex(index, value) {
        let result = (0, boolToNumber_1.boolToNumber)(value);
  ...
  data: ${dataString}
    ...
    convertColor(colorModel) {
        return (0, operations_1.convertColor)(this, colorModel);
    }
    // FILTERS
    /**
     ...
     */
    and(other, options) {
        return (0, filters_1.and)(this, other, options);
    }
    /**
     ...
     */
    or(other, options) {
        return (0, filters_1.or)(this, other, options);
    }
    // MASK ANALYSIS
    /**
    ...
    getBorderPoints(options) {
        return (0, maskAnalysis_1.getBorderPoints)(this, options);
    }
    /**
     ...
     */
    getConvexHull() {
        return (0, maskAnalysis_1.getConvexHull)(this);
    }
    /**
     ...
     */
    getFeret() {
        return (0, maskAnalysis_1.getFeret)(this);
    }
    // MORPHOLOGY
    /**
     * Erode a Mask.
     ...
     */
    erode(options) {
        return (0, erode_1.erode)(this, options);
    }
    /**
     * Dilate an image.
     *
     ...
     */
    clearBorder(options) {
        return (0, morphology_1.clearBorder)(this, options);
    }
    /**
     ...
     */
    floodFill(options) {
        return (0, morphology_1.floodFill)(this, options);
    }
    /**
     ...
     */
    solidFill(options) {
        return (0, morphology_1.solidFill)(this, options);
    }
    // DRAW
    /**
    ...
    drawLine(from, to, options = {}) {
        return (0, draw_1.drawLineOnMask)(this, from, to, options);
    }
    /**
    ...
    drawPolyline(points, options = {}) {
        return (0, draw_1.drawPolylineOnMask)(this, points, options);
    }
    /**
    ...
    drawPolygon(points, options = {}) {
        return (0, draw_1.drawPolygonOnMask)(this, points, options);
    }
    /**
    ...
    paintMask(mask, options) {
        return (0, operations_1.paintMaskOnMask)(this, mask, options);
    }
}
exports.Mask = Mask;
/**
