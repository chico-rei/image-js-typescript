...
import { getInterpolationFunction, InterpolationType, } from '../utils/interpolatePixel';
/**
...
export function transform(image, transformMatrix, options = {}) {
    const { borderType = BorderType.CONSTANT, borderValue = 0, interpolationType = InterpolationType.BILINEAR, fullImage, } = options;
